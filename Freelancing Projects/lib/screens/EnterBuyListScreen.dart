...
class BuyListEnterScreen extends StatefulWidget {
  final Map<String, dynamic>? product;

  BuyListEnterScreen({this.product});

  @override
  _ProductEnterScreenState createState() => _ProductEnterScreenState();
}

class _ProductEnterScreenState extends State<BuyListEnterScreen> {
  ...
  void _submitProduct() async {
    ...
    await FirebaseFirestore.instance.collection('buylist').add({
      'name': name,
      'company': company,
      'quantity': quantity,
      'unit': unit,
